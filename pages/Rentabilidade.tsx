...
import { Card, DataTable, IndicatorSelectorCard, CardActions } from '../components/ui';
import * as mockData from '../services/mockData';
import { PageHeader } from './PageHeader';
import type { SecondaryMenuContextProps } from '../components/layout/SecondaryMenuLayout';

const RentabilidadePageComponent: React.FC = () => {
    const data = mockData.visaoGeralRentabilidade;
    ...
    return (
     <>
      <PageHeader title="Rentabilidade" breadcrumbs={['Desempenho Comercial', 'Visão Geral', 'Rentabilidade']} showFilters={false} onToggleSecondaryMenu={context?.toggleSecondaryMenu} />
...
export const RentabilidadePage = React.memo(RentabilidadePageComponent);
